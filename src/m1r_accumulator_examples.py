...
#                  count = 0                  put it outside the loop
#                  if math.cos(r) > 0:        change r to (k + r)
#                      count = 1              count = count + 1
#                  return count               put it outside the loop.
#
...
#                  circle.attach_to(window)
#                  x = x + (2 * radius)
#                   it updates x by diameter adn by a multiple of k
###############################################################################
